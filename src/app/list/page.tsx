  ...
  return (
    <div className="px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 relative">
      ...
      <div className="hidden bg-pink-50 p-4 md:flex justify-between h-64">
        <div className="w-2/3 flex flex-col items-center justufy-center gap-8">
          <h1 className="font-semibold leading-[48px] text-4xl text-gray-700">
            Grab upto 50% off on <br />
            Selected Products
          </h1>
          <button className="rounded-3xl bg-mace text-white w-max py-3 px-5 text-sm">
            Buy Now
          </button>
        </div>
